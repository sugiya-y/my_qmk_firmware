 ...
 * |  `   |   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |Shift |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  GUI | Alt  |Lower |Space | Shift|Enter |Space |Raise |  Alt |  GUI |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_GRV,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT , \
                 KC_LGUI, KC_LALT,   LOWER,  KC_SPC, KC_LSFT,  KC_ENT, KC_SPC, RAISE,    KC_RALT, KC_RGUI\
),
 ...
 */
[_LOWER] = LAYOUT( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR, KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR,  KC_0  , _______, KC_DEL , \
  _______, _______, _______, KC_UP  ,_______, _______,                    _______, _______, _______, KC_P,   _______, _______,  \
  _______, _______, KC_LEFT, KC_DOWN,KC_RGHT, _______,                    _______, _______, _______, KC_SCLN,_______, _______, \
